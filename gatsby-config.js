const config = {
  ...
  shortTitle: 'FM Four card feature section',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Four card feature section" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-four-card-feature-section.netlify.app',
